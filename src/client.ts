...
export class Client {
    ...
    /**
     * Creates a new client. The access token is optional.
     *
     * @param accessToken The access token to use for the requests
     * @param apiUrl The URL of the API (default: https://api.librepass.org)
     */
    constructor(accessToken: string | undefined = undefined, apiUrl = 'https://api.librepass.org') {
        this.apiUrl = apiUrl;
        this.accessToken = accessToken;
    }

    /**
     * Sends a GET request to the API. Returns the JSON response.
     *
    ...
    /**
     * Sends a POST request to the API. Returns the JSON response.
     *
     * @param path The path to send the request to (e.g. /users)
    ...
    /**
     * Sends a PUT request to the API. Returns the JSON response.
     *
     * @param path The path to send the request to (e.g. /users)
     * @param body The body of the request
     * @returns The JSON response from the API
    ...
    /**
     * Sends a PATCH request to the API. Returns the JSON response.
     *
     * @param path The path to send the request to (e.g. /users)
     * @param body The body of the request
     * @returns The JSON response from the API
    ...
    /**
     * Sends a DELETE request to the API. Returns the JSON response.
     *
     * @param path The path to send the request to (e.g. /users)
     * @returns The JSON response from the API
     */
    ...
    /**
     * Sends a request to the API. Returns the JSON response.
     *
